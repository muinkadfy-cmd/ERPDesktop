...
partial class OrcamentosPedidosForm
{
    ...
    private void InitializeComponent()
    {
        ...
        _lblOrcSel = new Label();
        _st = new StatusStrip();
        _stMsg = new ToolStripStatusLabel();
        SuspendLayout();

        Text = ">>> ORÇAMENTOS / PEDIDOS <<<";
        ...
        _gridOrc.Dock = DockStyle.Fill;
        _gridOrc.BorderStyle = BorderStyle.None;
        ...
        _gbItens.Text = "Itens do orçamento selecionado";
        ...
        _lblOrcSel.ForeColor = Color.DimGray;
        _lblOrcSel.AutoEllipsis = true;
        ...
        tInc.Controls.Add(_lblOrcSel, 0, 6);
        tInc.SetColumnSpan(_lblOrcSel, 2);
        _gbIncluir.Controls.Add(tInc);

        _pDetItens.Controls.Add(_gbItens, 0, 0);
        _pDetItens.Controls.Add(_gbIncluir, 1, 0);

        _splitMain.Panel1.Controls.Add(_gridOrc);
