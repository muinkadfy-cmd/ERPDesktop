...
4. **Layout**  
   Utilitários em `src/ERPDesktop.App/Ui/` (`ErpTheme`, `ErpChrome`, `ErpGridStyle`, `ErpFormLayout`, `ToolbarIconsHd`, etc.); preferir reutilizar em novas telas. Ícones da barra: `ToolbarIconsHd` / `ToolbarIconsHdHelper` (vetorial HD + DPI).
